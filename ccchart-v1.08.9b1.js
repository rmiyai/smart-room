...
(function(window) {
  return {
    ...
    wscase: {
      ...
      // You can make custom pattern and modules.
      // pattern
      // http://ccchart.org/test/someCols/test-2.htm
      // modules
      // http://ccchart.org/plugins/ws/wscase/plain/wscase-plain.htm
      // http://ccchart.org/plugins/ws/wscase/plain/ccchart.wscase-plain-v0.01.js
